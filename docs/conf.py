...
latex_documents = [
    (master_doc, 'pytwask.tex', 'pytwask Documentation',
     'Wei Ren', 'manual'),
]
...
man_pages = [
    (master_doc, 'pytwask', 'pytwask Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pytwask', 'pytwask Documentation',
     author, 'pytwask', 'One line description of project.',
     'Miscellaneous'),
]
